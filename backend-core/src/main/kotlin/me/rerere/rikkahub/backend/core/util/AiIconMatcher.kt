...
fun computeAIIconByName(name: String): String? {
    ...
    val result = when {
        ...
        PATTERN_SILICON.containsMatchIn(lowerName) -> "siliconflow.svg"
...
private val PATTERN_ZHIPU = Regex("zhipu|glm")
...
private val PATTERN_BYTEDANCE = Regex("bytedance")
private val PATTERN_ALIYUN = Regex("aliyun")
private val PATTERN_SILICON = Regex("silicon")
...
private val PATTERN_STEP = Regex("step")
